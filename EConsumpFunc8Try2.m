function energy = EConsumpFunc8Try2(x0)
alpha01 = x0(1);
beta01 = x0(2);
beta02 = x0(3);
beta03 = x0(4);
...
u=@(h0,v0,v1,v2,v3,a1,a2,a3,a4,a5,a6) alpha01*(V(h0)-v0)+beta01*(W(v1)-v0)+...
    beta02*(W(v2)-v0)+beta03*(W(v3)-v0)+gamma01*a1+gamma02*a2+...
    gamma03*a3+gamma04*a4+gamma05*a5+gamma06*a6;
